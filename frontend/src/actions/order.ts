...
const edit: ActionCreator<ThunkAction<void, RootState, void>> = (
  ...
  return (dispatch: Dispatch<RootState>): void => {
    ...
    orderService.edit(order, orderId).then(
      () => {
        dispatch(success())
...
function getById(id: string) {
  return (dispatch: (action: Action) => void) => {
    ...
    orderService
      .getById(id)
      .then(
        (order: any) => dispatch(success(order)),
...
function cancell(id: string) {
  return (dispatch: (action: Action) => void) => {
    ...
    orderService
      ...
      .then(
        () => dispatch(success(id)),
        (error: any) => dispatch(failure(error, id))
      )
  }
...
function addComment(id: string, comment: string) {
  return (dispatch: (action: Action) => void) => {
    ...
    orderService.addComment(id, comment).then(
...
const getAll: ActionCreator<ThunkAction<void, RootState, void>> = (option: {
  ...
  return (dispatch: Dispatch<RootState>): void => {
    ...
    orderService
      .getAll(option)
      .then(
        (orders: Array<Order>) => dispatch(success(orders)),
