...
class ShippingPage extends React.Component<ShippingProps, ShippingState> {
    ...
    onSelect = (data:Record) => {
        const { goods } = this.state
        this.setState({ goods: { ...goods,consigneeId: data.id,address:data.address } } )
    }
                                   ...
                                   <div className="view-content">
                                        <div className="field" style={{ marginBottom: 0 }}>
                                            ...
                                            {dataSource && <EditableTable
                                                ...
                                                defaultConsigneeId={this.props.userProp.userData && this.props.userProp.userData.defaultConsigneeId}
