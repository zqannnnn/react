                ...
                <div className="blocks-container" >
                    {offer.items&&offer.items.map((item, index) =>
                        (<div key={item.id} className="block">
                            ...
                            <div className="status">{item.status!=offerConsts.OFFER_STATUS_FINISHED?'On Sale':'Sold'}</div>
                            {authInfo.isAdmin&&item.status!=offerConsts.OFFER_STATUS_FINISHED&&<div className="admin-menu" onClick = {()=>{
                                    if(item.id)
